...
export default function TopSectionWork3() {
  return (
    <div className="relative mt-33 xxl:mt-17">
      <div
        className={clsx(
          ...
          "xxl:text-[128px] xxl:tracking-[12.8px]"
        )}
      >
        HISTORY
      </div>
      ...
      <div
        className={clsx(
          ...
          "xxl:absolute xxl:left-[52vw] xxl:top-[229px] xxl:mb-[70px] xxl:p-0 xxl:text-left xxl:text-3xl"
        )}
      >
      ...
      <div className="absolute bottom-[161px] left-0 hidden xxl:block">
