  ...
  return (
    <div className="footer-container ">
        ...
        <div className="pre-footer">
          ...
          >
            ...
            <div className="mt-35 flex justify-center">
              <Button href={Routes.CONTACT}>お問い合わせ</Button>
            </div>
          </BackgroundSection>
        </div>
      )}
      <div className="footer flex flex-col items-center pb-14 xl:pb-12">
        ...
        <p className="mt-3 text-center text-md xl:mt-11 xl:text-[15px]">
          〒680-1417 鳥取県鳥取市桂見573番地
        </p>
        <p className="font-base text-center text-md xl:text-[15px]">
          TEL 0857-28-4788
        </p>
        ...
        <p className="mt-5 text-center text-sm xl:mt-11 xl:text-[15px]">
